namespace LiteGui.Graphics
{
    public abstract class LGuiCommandExecutor
    {
        ...
        public abstract void DrawTexture(int TextureID, LGuiRect SrcRect, LGuiRect DstRect);
        public abstract void DrawTexture(string FilePath, LGuiRect SrcRect, LGuiRect DstRect);
